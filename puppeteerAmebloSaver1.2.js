...
(async () => {
    console.log('Puppeteer Ameba Blog Saver 1.2');
    console.log('Author: Nakateru(2021.09.22)');

    //input URL
    const bloUrl = await inputUrl();
	//const bloUrl = 'https://ameblo.jp/ske48official/entry-12699232653.html';
    ...
    function inputUrl() {
        ...
        return new Promise((resolve, reject) => {
            reader.question('Input AmeBlo Entry or Theme URL:', url => {
    ...
    async function saveEntry(page, url) {
        ...
        //find images url
        var imgArr = await page.$$eval('img', ele => ele.map(x => x.getAttribute("src")));
        //console.log(imgArr);
